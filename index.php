...
<html lang="es">
  <head>
    ...
    <title>CRIPTOMEX - Una nueva manera de hacer negocios</title>
				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index.php"><h1><span>Cripto</span>Mex</h1></a>
						</div>
					</div>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="about.php">Sobre nosotros</a></li>
								<li role="presentation"><a href="services.php">Servicios</a></li>								
								<li role="presentation"><a href="portfolio.php">Productos</a></li>								
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2 class="animation animated-item-1">Esto es <span>CRIPTOMEX</span></h2>
                                    <p class="animation animated-item-2">Su vehiculo hacia la nueva economía</p>
                                    <a class="btn-slide animation animated-item-3" href="#">Conozca más</a>
                                </div>
                            </div>
	...
	<div class="about">
		<div class="container">
			...
			<div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" >
				<h2>Jamás había sido tan fácil</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus interdum erat 
				libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
				libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
				libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
